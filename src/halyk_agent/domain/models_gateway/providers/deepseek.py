...
_FACT_JSON_EXAMPLES: dict[str, dict[str, Any]] = {
    ...
    "OWNERSHIP": {
        ...
        "payload": {
            "kind": "OWNERSHIP",
            "entity_name": "Saryarka Capital Partners LLP",
            "ownership_percent": "42.3",
        },
        "evidence_fragment_ids": ["F001"],
        "quote": '"Saryarka Capital Partners" LLP 42.3%',
        "page_number": 1,
        "char_start": 0,
        "char_end": 40,
        "reason_code": "OK",
    ...
    "TRANSACTION_RECLASSIFICATION": {
        ...
        "payload": {
            ...
            "amount": {"value": "118447.52", "currency": "USD"},
    ...
    "AMOUNT_CORRECTION": {
        ...
        "payload": {
            ...
            "amount": {"value": "884204.16", "currency": "USD"},
        },
        "evidence_fragment_ids": ["F001"],
        "quote": "TXN-X-0031 фактическая сумма составляет $884,204.16",
        "page_number": 1,
        "char_start": 0,
        "char_end": 50,
        "reason_code": "OK",
